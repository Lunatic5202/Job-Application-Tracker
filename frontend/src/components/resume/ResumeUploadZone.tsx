  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-2">
          {resumes.length === 0 ? (
            <div className="p-3.5 text-center rounded-xl bg-white border border-dashed border-[#D9D9D9] text-xs text-[#788896] space-y-1">
              <p className="font-semibold text-[#1D2226]">No resumes in library</p>
              <p className="text-[11px]">Upload a resume above to begin ATS screening.</p>
            </div>
          ) : (
            resumes.map((resume) => {
