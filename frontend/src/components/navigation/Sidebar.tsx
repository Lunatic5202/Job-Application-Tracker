...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Messages', path: '/messages', icon: MessageSquare, badgeVariant: 'brand' },
  { label: 'Calendar', path: '/calendar', icon: Calendar },
  { label: 'Notifications', path: '/notifications', icon: Bell, badgeVariant: 'danger' },
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = NAV_ITEMS.map((item) =>
    item.path === '/messages'
      ? { ...item, badgeCount: unreadCounts.messages }
      : item.path === '/notifications'
        ? { ...item, badgeCount: unreadCounts.notifications }
        : item
  );
