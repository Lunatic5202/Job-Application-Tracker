...
export const AuthLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F3F2EF] via-white to-[#E8F3FF] text-[#1D2226] dark:from-[#101820] dark:via-[#182631] dark:to-[#102A43] dark:text-[#F4F7FA] flex flex-col justify-between overflow-x-hidden selection:bg-brand-500/30 selection:text-brand-200">
      {/* Top Header */}
      <header className="h-14 px-6 sm:px-10 flex items-center justify-between border-b border-[#D9D9D9] bg-white/75 dark:border-[#344657] dark:bg-[#182631]/75 backdrop-blur-md">
        <Link to="/login" className="flex items-center gap-2.5 group">
          ...
          <span className="font-extrabold text-base tracking-tight text-[#1D2226] dark:text-white font-sans">
        ...
        <span className="text-xs text-[#788896] dark:text-slate-400 hidden sm:inline-block">
        ...
        <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="hidden lg:flex lg:col-span-5 flex-col justify-center space-y-6 pr-4">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl font-extrabold text-[#1D2226] dark:text-white tracking-tight leading-snug">
            ...
            <div className="space-y-3 pt-2">
              {[
                ...
                return (
                  <div key={i} className="flex items-start gap-3 p-2.5 rounded-xl bg-white/70 dark:bg-[#1B2733]/70 border border-[#D9D9D9] dark:border-[#344657]">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-[#1D2226] dark:text-slate-200">{item.title}</h4>
                      <p className="text-[11px] text-[#56687A] dark:text-slate-400 leading-tight mt-0.5">{item.desc}</p>
                    </div>
                  </div>
                );
              })}
      ...
      {/* Subtle Footer */}
      <footer className="h-12 border-t border-[#D9D9D9] dark:border-[#344657] px-6 flex items-center justify-center text-[11px] text-[#788896] dark:text-slate-500">
